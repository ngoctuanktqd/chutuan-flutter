...
Future<dynamic> categoryDialogEdit(BuildContext context, CategoryModel item) {
  final formKey = GlobalKey<FormState>();
  final categoryController = Get.put(CategoryController());
  TextEditingController inputCategory = TextEditingController();
  inputCategory.text = item.name;
  categoryController.setIndexColor(item.idColor);
  return showDialog(
    context: context,
    builder: (context) {
              ...
              child: Form(
                ...
                child: TextFormField(
                  ...
                  validator: (value) {
                    ...
                    if (value != item.name &&
                        categoryController.listCategories.indexWhere(
                ...
                Obx(
                  () {
                    return Container(
                      ...
                      height: 13,
                      decoration: BoxDecoration(
                        color: listColor[categoryController.indexColor.value],
                          ...
                          () {
                            return Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                shape: BoxShape.circle,
                                border:
                                    index == categoryController.indexColor.value
                                        ? Border.all(
                                            color: Colors.white,
                                            width: 2,
                                          )
          ...
          InkWell(
            ...
            onTap: () {
              if (formKey.currentState!.validate()) {
                categoryController.updateCategory(item.id, inputCategory.text);
                inputCategory.clear();
                Get.back();
              }
            },
